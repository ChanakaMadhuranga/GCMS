...
<?php
                            if(isset($u_garbage['glass_sell']) && in_array('Glass',$b))
                            {            
                              if($u_garbage['glass_sell']!== '0')   {    
                            ?>

<tr>
                        <div class="row">
                     <td> <div class="col"> <?= $u_garbage['u_nic_no']?></div></td>  
                      <td>   <div class="col">Glass</div></td>  
                      <td>   <div class="col"> <input type="number" class="form-control pqty" value="<?= $u_garbage['glass_sell'] ?>"></div></td>  
                     ...
                     <td>    <div class="col">  <button class="btn btn-info btn-block text-light addItemBtn6"><i class="fas fa-truck"></i>&nbsp;&nbsp;Add to
                                            List</button></div></td>  </div>


                            <input type="hidden" class="u_nic_no" value="<?=$u_garbage['u_nic_no']?>">
                            <input type="hidden" class="pname" value="Glass">
                            <input type="hidden" class="pprice" value="<?=$rowA['Glass']?>">
                     
                            <input type="hidden" class="pcode" value="<?= $u_garbage['u_nic_no']."Glass".$u_garbage['glass_sell'] ?>">
