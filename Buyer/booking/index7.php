...
<?php
                            if(isset($u_garbage['polythene_sell']) && in_array('Polythene',$b))
                            {  
                              if($u_garbage['polythene_sell']!== '0')   {                
                            ?>
<tr>

                        <div class="row">
                     <td>   <div class="col"> <?= $u_garbage['u_nic_no']?></div></td>
                         <td>  <div class="col">Polythene</div></td>
                         <td>  <div class="col"> <input type="number" class="form-control pqty" value="<?= $u_garbage['polythene_sell'] ?>"></div></td>
                     ...
                     <td>      <div class="col">  <button class="btn btn-info btn-block text-light addItemBtn7"><i class="fas fa-truck"></i>&nbsp;&nbsp;Add to
                                            List</button></div></td></div>


                            <input type="hidden" class="u_nic_no" value="<?=$u_garbage['u_nic_no']?>">
                            <input type="hidden" class="pname" value="Polythene">
                            <input type="hidden" class="pprice" value="<?=$rowA['Polythene']?>">
                     
                            <input type="hidden" class="pcode" value="<?= $u_garbage['u_nic_no']."Polythene". $u_garbage['polythene_sell'] ?>">
