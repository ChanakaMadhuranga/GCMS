...
<?php
                            if(isset($u_garbage['metal_sell']) && in_array('Metal',$b))
                            {     
                              if($u_garbage['metal_sell']!== '0')   {             
                            ?>
<tr>

                        <div class="row">
                     <td>  <div class="col"> <?= $u_garbage['u_nic_no']?></div></td> 
                          <td> <div class="col">Metal</div></td> 
                       <td>    <div class="col"> <input type="number" class="form-control pqty" value="<?= $u_garbage['metal_sell'] ?>"></div></td> 
                     ...
                     <td>      <div class="col">  <button class="btn btn-info btn-block text-light addItemBtn5"><i class="fas fa-truck"></i>&nbsp;&nbsp;Add to
                                            List</button></div>
                                            </td> 
                                            </div>
                            ...
                            <input type="hidden" class="pname" value="Metal">
                            <input type="hidden" class="pprice" value="<?=$rowA['Metal']?>">
                     
                            <input type="hidden" class="pcode" value="<?= $u_garbage['u_nic_no']."Metal".$u_garbage['metal_sell'] ?>">
