...
<?php
                            if(isset($u_garbage['coconut_shell_sell']) && in_array('Coconut_shell',$b))
                            {       
                              if($u_garbage['coconut_shell_sell']!== '0')   {        
                            ?>

<tr>
                        <div class="row">
                  <td>     <div class="col"> <?= $u_garbage['u_nic_no']?></div></td> 
                    <td>     <div class="col">Coconut_shell</div></td> 
                     <td>    <div class="col"> <input type="number" class="form-control pqty" value="<?= $u_garbage['coconut_shell_sell'] ?>"></div></td> 
                     ...
                     <td>    <div class="col">  <button class="btn btn-info btn-block text-light addItemBtn4"><i class="fas fa-truck"></i>&nbsp;&nbsp;Add to
                                            List</button></div>
                                            </td> 
                                            </div>
                            ...
                            <input type="hidden" class="pname" value="Coconut_shell">
                            <input type="hidden" class="pprice" value="<?=$rowA['Coconut_shell']?>">
                     
                            <input type="hidden" class="pcode" value="<?= $u_garbage['u_nic_no']."Coconut_shell".$u_garbage['coconut_shell_sell'] ?>">
