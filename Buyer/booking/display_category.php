...
/*$query="select 'paper_sell' as 'Paper','plastic_sell' as 'Plastic',u_nic_no from  update_bin "; */
 $query="SELECT * FROM cart where b_nic_num='$b11' and route='route1' ";
...
$q=mysqli_query($con,"select distinct route from cart where b_nic_num='$b11' ");
while($rowww=mysqli_fetch_assoc($q))
{

  $route_name[]= $rowww['route'];
}
foreach($route_name as $routes)
{
 echo' 
  
    ';
 echo' <a href="#" class="btn btn-danger" role="button" aria-presse="true">'.$routes.'</a>'."<br>";
 /*echo'<div class="table-responsive mt-2">

 <table class="table table-striped text-center"> <thead><tr>*/
 ?>
 <b> <div class="row">
 <div class="col-2">Seller NIC Number</div>
 <div class="col">Category</div>
 <div class="col">price</div>

 <div class="col">Quantity</div>
 <?php /*<div class="col">Quality</div>*/?>
 <div class="col">Route</div>
 <div class="col-2">Action</div></div></b><hr>
<?php


$query="SELECT * FROM cart where b_nic_num='$b11' and route='$routes' ";
$result = mysqli_query($con, $query);
...
<div class="row">
    <div class="col-2"><?= $garbage['u_nic_no']?></div>
...
<div class="col-2"><button class="btn btn-info btn-block addItemBtn"><i class="fas fa-truck"></i>&nbsp;&nbsp;
